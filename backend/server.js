...
const resposta = await fetch('https://pt.wikipedia.org/w/api.php?action=query&list=search&srsearch=&format=json&origin=*', {
    method: 'GET',
    headers: {
...
//transforma a resposta em json e envia pro front de volta
